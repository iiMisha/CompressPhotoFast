...
- `Task(Explore, "very thorough", "Проанализировать всю структуру проекта CompressPhotoFast")`
...
- Если `focus_source` не указан - используй `Task(Explore, "medium", "Найти изменения в проекте")`
