...
**Скилл МОЖЕТ изменять ТОЛЬКО файлы в папке `.claude/memory-bank/`**

**ЗАПРЕЩЕНО:**
- ❌ Использовать `Write` или `Edit` для любых файлов вне `.claude/memory-bank/`
- ❌ Создавать новые файлы вне `.claude/memory-bank/`
...
- ✅ `Write` и `Edit` ТОЛЬКО для файлов в `.claude/memory-bank/`
...
**⚠️ ЗАПОМНИ: МОЖНО изменять только файлы в `.claude/memory-bank/`**
