...
В приложении была выявлена проблема с созданием файлов с двойными расширениями (например, `image.HEIC.jpg`). При обработке файлов формата HEIC/HEIF происходит преобразование в JPEG, но имя файла может содержать двойное расширение. Эта проблема требует решения путем очистки имен файлов от лишних расширений и корректной обработки MIME-типов.