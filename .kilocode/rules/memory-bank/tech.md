...
*   **concurrent.futures.ThreadPoolExecutor**: Для параллельной обработки изображений с использованием всех доступных ядер CPU.
*   **threading.Lock**: Для thread-safe доступа к статистике сжатия.
