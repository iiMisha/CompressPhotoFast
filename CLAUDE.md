...
**ПРИОРИТЕТ:** Всегда используйте субагентов вместо прямого поиска (Glob/Grep) при:
- Открытом поиске информации в кодовой базе
- Анализе нескольких файлов или директорий
- Изучении паттернов и архитектуры
- Выполнении многоэтапных исследований