...
Для выполнения сложных задач необходимо активно использовать субагенты (Task tool) для:

- **Исследования кодовой базы:** Используйте субагент типа `Explore` для поиска файлов, анализа архитектуры и понимания структуры проекта
- **Специализированных задач:** Используйте специализированных агентов (например, `voltagent-lang:kotlin-specialist` для Kotlin-кода, `voltagent-infra:devops-engineer` для DevOps-задач)
- **Параллельного выполнения:** Запускайте нескольких субагентов параллельно для ускорения работы над независимыми задачами